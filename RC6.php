<?php
    ...
    class RC6{
        ...
        //function index(){
            ...
            // $key = $this->keySchedule("saiful");
            // print_r($key);
            // print_r(blockConverter("yogi"));
            // $chiper = encrypt(str_pad("123456789", 16), $key);
            // echo $hasilReverseBlock = reverseBlockConverter($chiper);

            // $plaintext = decrypt(str_pad($hasilReverseBlock, 16), $key);
            // $hasilDecrypt = reverseBlockConverter($plaintext);
            // echo $hasilReverseBlock . " " . $hasilDecrypt;
        ...
        public function ROR($x, $n, $bits = 32)
        {
        ...
        public function ROL($x, $n, $bits = 32)
        {
        ...
        public function blockConverter($input)
        {
        ...
        public function reverseBlockConverter($block, $status)
        {
            //variable inisialization
            $sentence = "";
        ...
        public function keySchedule($userKey)
        {
            ...
            $encode = $this->blockConverter($userKey);
        ...
        public function encrypt($sentence, $s)
        {
            ...
            // convert array cipher into decimal when status is encrypt
            $cipherText = $this->reverseBlockConverter($cipher, 'encrypt');
        ...
        public function decrypt($sentence, $s)
        {
            ...
            // convert array cipher into decimal when status is encrypt
            $plainText = $this->reverseBlockConverter($original, "decrypt");
