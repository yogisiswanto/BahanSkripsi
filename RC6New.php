<?php
    ...
    // class RC6{
        ...
        // function index(){
            ...
            // Key Scheduling
            $key = keySchedule("122");
            $key2 = keySchedule("123");

            // Encryption
            $encrypt1 = encrypt("123", $key);
            $encrypt2 = encrypt("123", $key2);

            // Reversing Block Encryption
            $cipherText1 = reverseBlockConverter($encrypt1);
            $cipherText2 = reverseBlockConverter($encrypt2);
            ...
            // Key Scheduling
            $key3 = keySchedule("ABCDE");

            // Encryption
            $encrypt3 = encrypt("ABCDE", $key3);
            $encrypt4 = encrypt("ABCDF", $key3);

            // Reversing Block Encryption
            $cipherText3 = reverseBlockConverter($encrypt3);
            $cipherText4 = reverseBlockConverter($encrypt4);
           
            echo 'Key = ABCDE<br/>';
            echo 'Plain Text 1 = ABCDE<br/>';
            echo 'Plain Text 2 = ABCDF<br/>';
            echo '-----------------------------<br/>';
            echo 'Cipher Text 1 = ' . $cipherText3 . '<br/>';
            echo 'Cipher Text 2 = ' . $cipherText4 . '<br/>';
           
            // Avalanche Effect
            avalancheEffect($cipherText3, $cipherText4);
